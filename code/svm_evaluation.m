function [accuracy, precision, recall, f1, specificity, misclassifiedInfo] = svm_evaluation(svmModel, features, groundtruth, lesionImages, segmentationMethod)
    ...
    % Capture misclassified images directly from within svm_evaluation
    misclassifiedInfo = capture_misclassified_images(svmModel, testFeatures', testLabels, lesionImages(testInd), segmentationMethod);
end
